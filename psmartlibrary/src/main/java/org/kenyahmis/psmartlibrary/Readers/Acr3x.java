...
public class Acr3x extends PreferenceActivity implements CardReader{
    ...
    public static final String SAMPLE_READ = "4B5";

    public static final String HEX_MESSAGE ="";
    public static final String SHR_MESSAGE = "{\n" +
            "\n" +
            " \"ADDENDUM\": {\n" +
            "\n" +
            "   \"CARD_DETAILS\": {\n" +
    ...
    //Read picc
    private class OnGetReadPreferenceClickListener implements
            Preference.OnPreferenceClickListener {
       ...
       /* Show the status. */
        ...
        public boolean onPreferenceClick(Preference preference) {
            ...
            mAboutReaderSleepTimeoutPreference.setSummary("");
            mReader.start();
            final boolean customId = mReader.getCustomId();
            boolean deviceId = mReader.getDeviceId();
            boolean dukptOption = mReader.getDukptOption();
            boolean firmwareVersion = mReader.getFirmwareVersion();
            boolean trackDataOption = mReader.getTrackDataOption();
            final Context context = mAboutReaderReadPreference.getContext();
            //Reads the card into a summary
            // CharSequence summary = mAboutReaderGetStatusPreference.getSummary();
            String summary =HEX_MESSAGE;
            byte [] response=null;
            if(summary !=null){
                response = hexStringToByteArray(summary);
            }
            String s = new String(response);
            String stringFormat  = convertHexToStringValue(summary);

            boolean status = mReader.getStatus();
            int cardState = mReader.getCardState(0);
            int protocol = mReader.getProtocol(0);

            if(summary != null){
                mProgress.setMessage("Bytes=>"+response+"String=>"+stringFormat);
                //To integrate use bytes ==>response

                // mProgress.setMessage("SM"+summary+"STT"+status+"CID"+customId+"DID"+deviceId+"DKP"+dukptOption+"FWV"+firmwareVersion+"TRK"+trackDataOption);
            }else{
                mProgress.setMessage("Reader not plugged in");
            }
            mProgress.show();
    ...
    private class OnGetWritePreferenceClickListener implements
            Preference.OnPreferenceClickListener {
        ...
        public boolean onPreferenceClick(Preference preference) {
            ...
            final Context context = mAboutReaderReadPreference.getContext();
            CharSequence summary = mAboutReaderGetStatusPreference.getSummary();
            System.out.println(mFirmwareVersionReady);
            boolean status = mReader.getStatus();

            if(summary != null){
                mProgress.setMessage("SM"+summary+"STT"+status+"CID"+customId+"DID"+deviceId+"DKP"+dukptOption+"FWV"+firmwareVersion+"TRK"+trackDataOption);
            }else{
                mProgress.setMessage("This is switched to transmit");
            }
            /* Show the progress. */
                ...
                public void run() {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            /* Show the card state. */
                            mIccCardStatePreference
                                    .setSummary(toCardStateString(mReader
                                            .getCardState(0)));
                        };
                    });
                }
    ...
    private class OnIccTransmitPreferenceClickListener implements
        ...
        public boolean onPreferenceClick(Preference preference) {
            ...
            /* Show the progress. */
            mProgress.setMessage("Transmitting the command APDU..."+mResponseApdu);
            mProgress.show();
    ...
    private class OnIccUpdateCardStatePreferenceClickListener implements
            Preference.OnPreferenceClickListener {
        ...
        public boolean onPreferenceClick(Preference preference) {
            ...
            mIccCardStatePreference.setSummary("");

            /* Show the progress. */
            mProgress.setMessage("Updating the card state...");
            mProgress.show();
    ...
    private class OnPiccTransmitPreferenceClickListener implements
        ...
        private class Transmit implements Runnable {
            ...
            public void run() {
                ...
                mResultReady = false;
                //To convert to hex, first convert to byte array
                String piccCommandApduString = SHR_MESSAGE;
                mPiccCommandApdu = toByteArray(piccCommandApduString);
        ...
        public boolean onPreferenceClick(Preference preference) {
            ...
            //To convert to hex, first convert to byte array
            mPiccCommandApdu = toByteArray(piccCommandApduString);
            String mPiccApdu = toHexString(mPiccCommandApdu);

//            /* Show the progress. */
            //mProgress.setMessage("Transmitting SHR==>"+mPiccApdu+"Byte array==>"+mPiccCommandApdu+"String==>"+piccCommandApduString);
            mProgress.setMessage("Transmitting SHR==>"+mPiccApdu);
            mProgress.show();
    ...
    private Preference mAboutReaderReadPreference;
    private Preference mAboutReaderWritePreference;
    ...
    private Preference mAboutReaderSetPatrickPreference;
    ...
    private Preference mIccCardStatePreference;
    private Preference mIccUpdateCardStatePreference;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAboutReaderReadPreference = findPreference("about_reader_read");
        mAboutReaderWritePreference = findPreference("about_reader_write");
        ...
        mAboutReaderSetPatrickPreference = findPreference("about_reader_set_patrick");
        ...
        mIccCardStatePreference = findPreference("icc_card_state");
        mIccUpdateCardStatePreference = findPreference("icc_update_card_state");
        ...
        if (savedInstanceState != null) {
            ...
            mIccCardStatePreference.setSummary(savedInstanceState
                    .getCharSequence("icc_card_state"));
        ...
        mAboutReaderSetSleepTimeoutPreference
         ...
         /*Read and write data */
        mAboutReaderReadPreference
                .setOnPreferenceClickListener(new OnGetReadPreferenceClickListener());
        mAboutReaderWritePreference
                .setOnPreferenceClickListener(new OnPiccTransmitPreferenceClickListener());
        // write is transmit
        //.setOnPreferenceClickListener(new OnGetWritePreferenceClickListener());
        ...
        /* Set the ICC "Update card state" preference click callback. */
        mIccUpdateCardStatePreference
                .setOnPreferenceClickListener(new OnIccUpdateCardStatePreferenceClickListener());
        ...
        /* Set the PICC "Transmit" preference click callback -->write. */
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putCharSequence("about_reader_read",
                mAboutReaderReadPreference.getSummary());
        outState.putCharSequence("about_reader_write",
                mAboutReaderWritePreference.getSummary());
        ...
        outState.putCharSequence("icc_card_state",
                mIccCardStatePreference.getSummary());
    ...
    private String toCardStateString(int cardState) {

        String cardStateString = null;

        switch (cardState) {

            case AudioJackReader.CARD_UNKNOWN:
                cardStateString = "Unknown";
                break;

            case AudioJackReader.CARD_ABSENT:
                cardStateString = "Absent";
                break;

            case AudioJackReader.CARD_PRESENT:
                cardStateString = "Present";
                break;

            case AudioJackReader.CARD_SWALLOWED:
                cardStateString = "Swallowed";
                break;

            case AudioJackReader.CARD_POWERED:
                cardStateString = "Powered";
                break;

            case AudioJackReader.CARD_NEGOTIABLE:
                cardStateString = "Negotiable";
                break;

            case AudioJackReader.CARD_SPECIFIC:
    ...
    private void clearData() {
        ...
        mSwipeCount = 0;
        mAboutReaderReadPreference.setSummary("");
        mAboutReaderWritePreference.setSummary("");
        mAboutReaderFirmwareVersionPreference.setSummary("");
        mAboutReaderBatteryLevelPreference.setSummary("");
        mAboutReaderSleepTimeoutPreference.setSummary("");
            ...
            if (mStatusReady) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        /* Show the timeout. */
                        Toast.makeText(mContext, "Read operation timed out. Check reader and card status",
                                Toast.LENGTH_LONG).show();
                    }
                });
            }
            ...
            if (mPiccResponseApduReady) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        mProgress.setMessage("Transmitted successfully");
                        mProgress.show();
                    }
                });
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        /* Show the timeout. */
                        Toast.makeText(mContext, "Write timed out. Check reader or card status.",
                                Toast.LENGTH_LONG).show();
                    }
                });
            }
